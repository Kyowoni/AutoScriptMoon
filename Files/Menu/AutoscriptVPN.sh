...
# Script name
MyScriptName='MoonlightVPN Script'
...
function InstWebmin(){
 ...
 WebminFile='https://github.com/Kyowoni/AutoScriptDB/raw/master/Files/Plugins/webmin_1.920_all.deb'
...
function OvpnConfigs(){
 ...
 cat <<'myNginxC' > /etc/nginx/conf.d/moonlight-ovpn-config.conf
...
myNginxC
 ...
 sed -i "s|myNginx|$OvpnDownload_Port|g" /etc/nginx/conf.d/moonlight-ovpn-config.conf
...
[Unit]
Description=MoonlightVPN Startup Script
